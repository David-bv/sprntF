...
import { questionCss } from '../../data/Question';
...
export default class QuestionCss extends Component {
    ...
    componentDidMount() {
        const currentQuizData = questionCss[this.state.numberQuestion]
        this.setState({
            question: {
    ...
    handleSubmit = (e) => {
        ...
        if (this.state.numberQuestion < questionCss.length) {
                ...
                <FormStyle onSubmit={this.handleSubmit}>
                    <Form.Group controlId='control_radio' >
                        <HeaderForm>
                            ...
                            <BarCont variant="success" now={this.state.numberQuestion} max={questionCss.length} />
