...
import { questionUx } from '../../data/Question';
...
export default class QuestionUx extends Component {
    ...
    componentDidMount() {
        const currentQuizData = questionUx[this.state.numberQuestion]
        this.setState({
            question: {
    ...
    handleSubmit = (e) => {
        ...
        if (this.state.numberQuestion < questionUx.length) {
                ...
                <FormStyle onSubmit={this.handleSubmit}>
                    <Form.Group controlId='control_radio' >
                        <HeaderForm>
                            ...
                            <BarCont variant="success" now={this.state.numberQuestion} max={questionUx.length} />
